package com.pemmob.azizamirul.data.dummy
...
object DummyData {
    ...
    val products = listOf(
        ...
        Product(2, 1, categories[0], "Mendoan", "Kripik gurih", 20000.0, 30,"dummy_product"),
        Product(3, 1, categories[0], "Sale Pisang", "Kripik gurih", 25000.0, 20,"dummy_product"),
        Product(4, 1, categories[0], "Getuk Goreng", "Kripik gurih", 30000.0, 40,"dummy_product"),
        Product(5, 1, categories[0], "Nopia", "Kripik gurih", 22000.0, 60,"dummy_product"),
